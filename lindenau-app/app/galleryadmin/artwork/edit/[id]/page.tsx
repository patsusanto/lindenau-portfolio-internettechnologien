  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        formDataToSubmit.append("image", new Blob([], { type: "application/octet-stream" }))
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="position">Position in Gallery (1-{artworkCount})</Label>
                  <Input
                    id="position"
                    name="position"
                    type="number"
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    This determines the order in which artworks appear in the gallery.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <Button type="submit" className="bg-black hover:bg-black/80" disabled={isSubmitting}>
